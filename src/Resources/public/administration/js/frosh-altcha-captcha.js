...
{% endblock %}
`});var s={};h(s,{default:()=>r});var r,i=c(()=>{o();r=Shopware.Component.wrapComponentConfig({template:l,compatConfig:Shopware.compatConfig})});Shopware.Component.override("sw-settings-captcha-select-v2",()=>Promise.resolve().then(()=>(i(),s)));})();
