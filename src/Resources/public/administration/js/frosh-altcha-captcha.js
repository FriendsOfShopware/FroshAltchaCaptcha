(()=>{var n=Object.defineProperty;var c=(a,t)=>()=>(a&&(t=a(a=0)),t);var h=(a,t)=>{for(var e in t)n(a,e,{get:t[e],enumerable:!0})};var s,l=c(()=>{s=`<!-- eslint-disable-next-line sw-deprecation-rules/no-twigjs-blocks -->
...
{% endblock %}
`});var i={};h(i,{default:()=>p});var p,o=c(()=>{l();p=Shopware.Component.wrapComponentConfig({template:s,compatConfig:Shopware.compatConfig})});Shopware.Component.override("sw-settings-captcha-select-v2",()=>Promise.resolve().then(()=>(o(),i)));})();
